...
export const SUPPORTED_APPS = [
  { id: 'youtube', name: 'YouTube', description: 'Allow Brom to play videos on YouTube.' },
  { id: 'chrome', name: 'Google Chrome', description: 'Allow Brom to open web pages.' },
  { id: 'spotify', name: 'Spotify', description: 'Allow Brom to play music on Spotify.' },
  { id: 'whatsapp', name: 'WhatsApp', description: 'Allow Brom to send messages via WhatsApp.' },
  { id: 'instagram', name: 'Instagram', description: 'Allow Brom to open Instagram.' },
  { id: 'facebook', name: 'Facebook', description: 'Allow Brom to interact with Facebook.' },
];
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <p className="text-center text-gray-400 mb-8 max-w-lg mx-auto">
        Control which applications Brom AI can interact with on your device. These permissions are used for features like opening apps and playing media.
      </p>
